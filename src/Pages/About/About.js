            ...
            <div className="aboutContainer">
                <div className='illustContainer'>
                    ...
                    <motion.figcaption variants={marshmallowsAnim}>
                        <i>illust:
                            <span title="She is too shy to share her instagram :P">Amane</span>
                        </i>
                    </motion.figcaption>
                </div>
                <motion.p variants={infoAnim}>
                    Hey! I'm Ng Jing Kai (aka marshmellochoco), a student from Malaysia who is
                    currently pursuing a Software Engineering degree. I am passionate toward Web
                    ...
                    <motion.a
                        ...
                        variants={iconAnim}
                        whileHover="hover">
                        <img src={githubSvg} alt="Github" className="contactIcon"/>
                    </motion.a>
                    <motion.a
                        href="mailto:jingkai.ng2@gmail.com"
                        variants={iconAnim}
                        whileHover="hover">
                        <img src={mailSvg} alt="E-mail" className="contactIcon"/>
                    </motion.a>
                </motion.p>
            </div>
        </motion.div>
